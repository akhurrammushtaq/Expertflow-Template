...
(function () {
  ...
  var CSS = [
    ...
    /* Outbound modal dark mode — elevated above the canvas */
    '#app.dark .outbound-modal,html.ef-dark .outbound-modal{background:#252a30;border-left-color:#3a3f48;box-shadow:-8px 0 36px rgba(0,0,0,.6);}',
    '#app.dark .ob-search-wrap,html.ef-dark .ob-search-wrap{background:#1e2022;border-color:#3a3f48;}',
    '#app.dark .ob-dialpad-tog,html.ef-dark .ob-dialpad-tog{background:#1e2022;border-color:#3a3f48;}',
    '#app.dark .ob-anon-bar,html.ef-dark .ob-anon-bar{background:#1e2022;border-color:#3a3f48;}',
    '#app.dark .ob-anon-btn,html.ef-dark .ob-anon-btn{background:#1e2022;border-color:#3a3f48;}',
    '#app.dark .ob-group-hdr,html.ef-dark .ob-group-hdr{background:#252a30;}',
    '#app.dark .ob-contact,html.ef-dark .ob-contact{border-bottom-color:#2c2f35;}',
    '#app.dark .ob-contact:hover,html.ef-dark .ob-contact:hover{background:#2c2f35;}',
    '#app.dark .ob-close-btn:hover,html.ef-dark .ob-close-btn:hover{background:#2c2f35;}',
    '#app.dark .dial-btn,html.ef-dark .dial-btn{background:#1e2022;border-color:#3a3f48;}',
    '#app.dark .ob-del-btn,html.ef-dark .ob-del-btn{background:#1e2022;border-color:#3a3f48;}',
    '#app.dark .sms-to-inp,html.ef-dark .sms-to-inp,#app.dark .sms-msg-inp,html.ef-dark .sms-msg-inp{background:#1e2022;border-color:#3a3f48;}',
    '#app.dark .ob-sms-composer,html.ef-dark .ob-sms-composer,#app.dark .ob-email-composer,html.ef-dark .ob-email-composer,#app.dark .ob-wa-composer,html.ef-dark .ob-wa-composer{border-top-color:#3a3f48;}',
    '#app.dark .ob-footer,html.ef-dark .ob-footer{border-top-color:#3a3f48;}',
    '#app.dark .sms-cancel-btn,html.ef-dark .sms-cancel-btn{background:#1e2022;border-color:#3a3f48;}',
    '#app.dark .ob-btn.secondary,html.ef-dark .ob-btn.secondary{background:#1e2022;border-color:#3a3f48;color:var(--color-text);}',
    '#app.dark .ob-btn.secondary:hover,html.ef-dark .ob-btn.secondary:hover{background:#2c2f35;}',
    /* Field inline errors */
