...
1. **One canvas, one new file.** when ever i ask to create list screen always follow the `list-view-template.html` layout dont create new design
...
8. **Global top navigation** 
When ask to add in top nav bar make change in `navbar.js` and make change globally and on all the screens 

9. **Ask Questions** 
Whenever i start new flow or componants always ask questions if you dont understand anything
