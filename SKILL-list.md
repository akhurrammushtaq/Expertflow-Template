...
10. **Icons:** Always use icons from google material icon library, and if there is some issue keep inline SVG but use Material Icon-style shapes (same visual style, just embedded)
