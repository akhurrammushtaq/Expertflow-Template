...
(function () {
  ...
  var CSS = [
    ...
    '.list-search input,.vm-search-inp{border:none;background:transparent;font-size:13px;color:var(--color-body);width:100%;outline:none;font-family:Roboto,sans-serif;}',
